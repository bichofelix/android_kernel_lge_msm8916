...
//#define ISP_EVENT_WM_BUS_OVERFLOW (ISP_EVENT_BASE + ISP_WM_BUS_OVERFLOW)	//qct original
#define ISP_EVENT_WM_BUS_OVERFLOW (ISP_EVENT_BASE + ((ISP_WM_BUS_OVERFLOW+1) << ISP_EVENT_OFFSET)) //                                                                            
